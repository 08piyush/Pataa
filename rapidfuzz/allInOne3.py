...
#  WHICH QUERY DOES WHAT ? 
        ...
        #  QUERY4 searching only in records where value is non-numeric,combined with query5 and metaphone
        #  e.g. polace , nagar, house 45, 566ADF. / non-examples : 456, 12 etc. , now 
        #  QUERY5 searching for the values greater than the length of string in address2 and address3   
        #  QUERY6 searching in complete data (removed for large databases)
